      ...
      datasets: [
        {
          ...
          backgroundColor: "white", // Fill color (for line)
          borderWidth: 2,
        },
      ],
    },
...
var defaultmain = `
<div class="heading">
        <div style="display:flex;justify-content:space-between;"><h1>Patient OverView</h1>
    ...
    <div class="cold">
        ...
        <div class="graph-container">
          <div class="overlay">Pain Report</div>
          <canvas id="painReport"></canvas>
        </div>
        <div class="graph-container">
          <div class="overlay">Medicines</div>
          <canvas id="medicines"></canvas>
        </div>
      </div>
      <h1 style="color: white;margin-top: 10vh;margin-left: 20px;">Patient Talks</h1>
...
function getalarm(){
  ...
  fetch("http://localhost:7000/alarm", {
    method: "POST",
    headers: {
...
function getAlerts(){
  ...
  fetch("http://localhost:7000/alerts", {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
